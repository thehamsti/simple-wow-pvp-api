...
export const classicCharacterRoute = createRoute({
  method: 'get',
...
export const classicCharacterHandler = async (c: any) => {
  try {
    ...
    const validFields = ['character', 'honor', 'ratings', 'last_updated', 'game_version', 'class', 'spec', 'faction', 'race', 'gender', 'level', 'average_item_level', 'equipped_item_level']
